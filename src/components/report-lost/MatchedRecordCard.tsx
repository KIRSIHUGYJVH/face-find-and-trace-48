            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-3">
              <div className="flex items-start gap-2 bg-gray-50 p-2 rounded-md">
                ...
                <div className="overflow-hidden">
                  ...
                  <div className="capitalize text-sm font-medium truncate">{match.matched_with.gender}</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 bg-gray-50 p-2 rounded-md">
                ...
                <div className="overflow-hidden">
                  ...
                  <div className="text-sm font-medium truncate">{match.matched_with.age}</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 bg-gray-50 p-2 rounded-md">
                ...
                <div className="overflow-hidden">
                  ...
                  <div className="text-sm font-medium break-words line-clamp-2">{match.matched_with.where_found}</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 bg-gray-50 p-2 rounded-md">
                ...
                <div className="overflow-hidden">
                  ...
                  <div className="text-sm font-medium break-words line-clamp-2">{match.matched_with.your_name}</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 bg-gray-50 p-2 rounded-md">
                ...
                <div className="overflow-hidden">
                  ...
                  <div className="text-sm font-medium break-words line-clamp-2">{match.matched_with.organization}</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 bg-gray-50 p-2 rounded-md">
                ...
                <div className="overflow-hidden">
                  ...
                  <div className="text-sm font-medium break-words line-clamp-2">{match.matched_with.designation}</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 bg-gray-50 p-2 rounded-md">
                ...
                <div className="overflow-hidden">
                  ...
                  <div className="text-sm font-medium break-words line-clamp-2">{match.matched_with.mobile_no}</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 bg-gray-50 p-2 rounded-md">
                ...
                <div className="overflow-hidden">
                  ...
                  <div className="text-sm font-medium break-all line-clamp-2">{match.matched_with.email_id}</div>
                </div>
              </div>
            </div>
          </div>
